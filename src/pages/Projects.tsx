...
function Projects(){
  ...
  return (
    <>
      ...
      <motion.div 
        className={`flex flex-col md:flex-row items-center gap-3 w-full min-w-85 overflow-x-hidden md:overflow-x-auto overflow-y-auto md:overflow-y-hidden ${styles.projectsContainer}`}
        initial={{ height: 0 }}
        animate={{ height: 300 }}
        transition={{
          duration: 0.7,
